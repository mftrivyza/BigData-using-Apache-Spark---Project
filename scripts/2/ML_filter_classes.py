...
spark = SparkSession.builder.appName("ML_filter_classes").getOrCreate()
...
customer_complaints_DF = customer_complaints_DF.join(class_count, "string_label", "inner").drop("count")
...
train = customer_complaints_DF.sampleBy("label", fractions={0: 0.75, 1: 0.75, 2: 0.75, 3: 0.75, 4: 0.75, 5: 0.75, 6: 0.75, 7: 0.75, 8: 0.75, 9: 0.75, 10: 0.75, 11: 0.75, 12: 0.75}, seed = 1234)
